...
/* Преобразование в C++ без MPI под Windows: Reenterable.exe -followdefines -nosourcelines -D_WIN32 -D_MSC_VER -D__OPENMP__ -D__MVS__ eko_3d.c reent1.cpp */
...
#endif
{
 ...
 KGlobal.MaxIterations = 300000; /* Максимальное число итераций */
